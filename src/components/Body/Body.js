...
function Requisitos() {
  return (
    <div className="category-content" id="requisitos">
      <p className="tittle"> Requisitos </p> {InstalarNPM()}{" "}
    </div>
  );
}
    ...
    <div className="secondary-content">
      ...
      <div className="description">
        ...
        <div className="code">
          ...
          <div className="content-code"> nvm install 18.12.1</div>{" "}
          <div className="content-code"> nvm use 18.12.1</div>{" "}
        </div>{" "}
      </div>{" "}
    </div>
  );
...
function InstalarDevTools() {
  return (
    <div className="category-content" id="instalar-dev-tools">
      <p className="tittle"> Instalar Dev TOOls </p> {DescargarTheme()}{" "}
      {DescargarExtensiones()} {GenerarAmbiente()}{" "}
    </div>
  );
}
    ...
    <div className="secondary-content">
      ...
      <div className="description">
        <p>
          ...
          encontramos al buscar <a> themedev </a> en la global search del
          backend en Netsuite{" "}
        </p>{" "}
      </div>{" "}
    </div>
    ...
    <div className="category-content" id="generar-token">
      ...
      <div className="secondary-content">
        <p className="sub-tittle">
          {" "}
          * Debemos de estar logueados en el backend *{" "}
        </p>{" "}
        <div className="description">
          <p>
          ...
          <p>
            ...
            <a> hostnameStep1 </a> y cambiamos rest por system, deberia quedar
          ...
          <div className="code">
            ...
            <div className="code-img">
              <img
                src="https://raw.githubusercontent.com/edpe2003/DocumentacionSCA/develop/src/img/token.png"
                alt="token"
              />
            </div>{" "}
          </div>{" "}
